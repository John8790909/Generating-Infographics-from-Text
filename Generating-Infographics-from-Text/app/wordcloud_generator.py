#------------------------------------------------------------------------------------------------
#-- GIFT Apps: wordcloud_generator.py
#------------------------------------------------------------------------------------------------
...
class WordcloudGenerator():
    ...
    ''' Generates a basic visual figure, rendering that image as a wordcloud graphic which contains frequent tokens '''   
    ...
    ''' Generates a masked visual figure, rendering that image as a wordcloud graphic which contains frequent tokens '''   
    ...
    ''' Generates a "flagged" shaped visual figure, rendering that image as a wordcloud graphic which contains frequent tokens '''   
